      ...
      <div className="container">
          ...
          <div className={styles.logo}>
            <Link href="/" className={styles.logoLink} onClick={closeMenu}>
              <Image 
                ...
                priority
                sizes="(max-width: 480px) 200px, (max-width: 768px) 220px, (max-width: 1023px) 240px, 260px"
              />
            </Link>
          </div>
        ...
        >
          ...
          <div className={styles.socialLinks}>
            <div className={styles.socialIcons}>
              <a 
                ...
                onClick={() => trackClick('whatsapp_social_mobile')}
                aria-label="WhatsApp"
              >
                <FaWhatsapp size={24} />
              </a>
              <a 
                ...
                rel="noopener noreferrer"
                className={styles.socialLink}
                onClick={() => trackClick('facebook_social_mobile')}
                aria-label="Facebook"
              >
              ...
              <a 
                ...
                rel="noopener noreferrer"
                className={styles.socialLink}
                onClick={() => trackClick('instagram_social_mobile')}
          ...
          <div className={styles.legalLinks}>
            <Link href="/terminos" className={styles.legalLink} onClick={closeMenu}>
              Términos y Condiciones
            </Link>
            <Link href="/privacidad" className={styles.legalLink} onClick={closeMenu}>
